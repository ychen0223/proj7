...
#
# Generated by export_simulation on Sat Apr 16 15:17:19 PDT 2022
#
################################################################################
...
'-reset_run' switch to the './uart_tx_0.sh' script.

./uart_tx_0.sh -reset_run
...
./uart_tx_0.sh -noclean_files

For more information on the script, please type './uart_tx_0.sh -help'.
