...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/my_multiplier_v1_0_tb_include.svh"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:my_multiplier:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/my_multiplier_v1_0_tb.sv
